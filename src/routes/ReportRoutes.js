...
const DailyProductOutNew = Loadable(lazy(() => import('pages/report/admin/DailyProductOutNew')));
...
const StepsHistory = Loadable(lazy(() => import('pages/report/admin/step-history/StepHistory')));
