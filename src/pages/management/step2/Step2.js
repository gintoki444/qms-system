  ...
  return (
    <Grid rowSpacing={2} columnSpacing={2.75}>
      <Grid item xs={12} md={7} lg={8}>
        ...
        <Grid container alignItems="center" justifyContent="flex-end">
          <Grid item xs={12}>
            <Typography variant="h3">กำลังขึ้นสินค้า</Typography>
          </Grid>

          <Grid item xs={12}>
            <MainCard content={false} sx={{ mt: 1.5 }}>
              <Box sx={{ pt: 1, pr: 2 }}>
                <Step2Table status={'processing'} />
              </Box>
            </MainCard>
          </Grid>
        </Grid>
        ...
        <Grid container alignItems="center" justifyContent="flex-end" sx={{mt:3}}>
          <Grid item xs={12}>
            <Typography variant="h3">รอคิว : ขึ้นสินค้า</Typography>
          </Grid>

          <Grid item xs={12}>
            <MainCard content={false} sx={{ mt: 1.5 }}>
              <Box sx={{ pt: 1, pr: 2 }}>
                <Step2Table status={'waiting'} />
              </Box>
            </MainCard>
          </Grid>
        </Grid>
