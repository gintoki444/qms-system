...
function Step1Completed() {
  ...
  const { onDownload } = useDownloadExcel({
    ...
    filename: `step1-summary-${filterName}`,
          ...
          <Stack spacing={2} sx={{ width: '100%' }}>
            <Stack direction="row" spacing={2} sx={{ width: '100%' }}>
              ...
              <TextField
                ...
                sx={{ flex: 1 }}
              />
              <SelectCompany onSelect={handleCompanySelect} value={selectedCompanyId} filterName={handleFilterName} />
