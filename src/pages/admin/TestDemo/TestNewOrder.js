...
import TestGetNavition from './TestGetNavition';
                    ...
                    <Grid item xs={12} md={6}>
                      <Stack spacing={1}>
                        ...
                        <Box display="flex" alignItems="center">
                          ...
                          />
                          <Box marginLeft={2}>
                            <TestGetNavition soNumber={SoNumber} onSetData={handleOnSetOrder} proCompanyID={values.product_company_id} />
