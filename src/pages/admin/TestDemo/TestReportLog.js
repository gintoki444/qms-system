...
const ExportExcel = ({ reportList }) => {
    ...
    //         try {
    //             const response = await axios.get('https://asia-southeast1-icp-qms-api.cloudfunctions.net/apia2/queueslogs?startDate=2024-07-21&endDate=2024-07-21');
    ...
    const formatDataForExcel = () => {
        ...
        worksheet.addRow([
            "ลำดับ", "วันที่จอง", "ทะเบียนรถ", "รหัสคิว", "รหัสคิวเดิม", "บริษัท/ร้าน", "คนขับ", "เบอร์", "เวลา QR Code", "Log User",
            "เลขที่คำสั่งซื้อ", "ตราสินค้า", "ข้อมูลสินค้า", "จำนวน (ตัน)", "เวลาที่กด", "Log User", "หมายเหตุ",
            "เวลาที่ชั่ง", "สถานี", "ชั่งเบา", "Log User", "เวลาที่ชั่ง", "สถานี", "ชั่งหนัก", "Log User",
            "หัวหน้าโกดัง", "พนักงานจ่ายสินค้า", "โฟล์คลิฟท์", "สายแรงงาน", "โกดัง", "หัวจ่าย", "เวลาที่กด", "Log User",
            "กองสินค้า", "ทะเบียน", "จำนวน", "ทุบปุ๋ย", "เกี่ยวสลิง", "เรียงสลิง", "เกี่ยวจัมโบ้", "เวลาที่เข้าหัว", "เวลาที่กด", "Log Userจ่าย"
        ]);
