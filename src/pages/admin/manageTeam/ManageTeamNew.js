...
import ManageTeamLoadingTable from './ManageTeamLoadingTable';

function ManageTeamNew() {
    const pageId = 22;
                        ...
                        {pageDetail.length !== 0 && (
                            <Grid item>
                                <MainCard content={false} sx={{ mt: 1.5 }}>
                                    <Box sx={{ pt: 1, pr: 2 }}>
                                        <ManageTeamLoadingTable permission={pageDetail[0].permission_name} />
                                    </Box>
                                </MainCard>
                            </Grid>
                        )}
